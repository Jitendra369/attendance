...
<body>
	...
	<div class="container-fluid">
		<div class="col-md-12 text-center ">
			<h2 style="color: orange;">Admin , Registration Form</h2>
		</div>
	</div>
		...
		<div class="row justify-content-center">
			<div class="col-md-8 col-10">
				<form id="form-regi" method="post" action="SaveRegistDataServlet">
					...
					<!-- <div class="form-group">
						<label class="from-ed" for="exampleInputPassword1">Admin
							ID </label> <input type="number" class="form-control from-ed"
							name="admin_id" id="emp_id">
						readonly="readonly"
					</div> -->

					<div class="form-group">

						<label class="from-ed" for="exampleInputEmail1">Date of Birth</label>
						<div>
							<input type='date' name="age" placeholder="mm/dd/yyyy" style="margin-top: 10px;">
						</div>
					...
					<div class="form-group">
						<label class="from-ed" for="exampleInputPassword1">Mobile
						</label> <input type="number" class="form-control from-ed"
							name="admin_mobile" id="emp_mobile">
					...
					<div class="form-group">
						...
						<label class="from-ed" style="display: block; margin-top: 10px">Gender</label>

						<input class="form-check-input from-ed" type="radio" name="gender"
					...
					<div class="row justify-content-center">
						<button type="submit" id="submit_btn"
							class="btn btn-primary from-ed mb-5" style="width: 150px;">Submit</button>
					</div>
